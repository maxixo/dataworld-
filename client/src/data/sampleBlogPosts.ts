// Sample blog posts data for seeding
// Run this script to populate the database with sample technology news
...
/**
 * Sample Blog Posts for DataWorld
 * 
 * This file contains 8 pre-written technology news articles for 2025.
 * 
 * HOW TO USE:
 * 1. Copy content from these posts and paste into the admin dashboard at /admin/blog/new
 * 2. Or create a script to import them programmatically (see BLOG_SETUP.md)
 * 
 * Each post includes: title, content, category, tags, and published status
 */
