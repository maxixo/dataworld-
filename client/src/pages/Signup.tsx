    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                <Item ok={specialOK} label="Special char" />
            </div>
        </div>
    );
}
            ...
            <div className="min-h-screen flex flex-col lg:flex-row">
                <div className="hidden lg:flex flex-col relative w-1/2 p-12 bg-surface-light dark:bg-surface-dark overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-center gap-3 mb-auto">
                        ...
                        <div>
                            <h2 className="text-4xl font-bold leading-tight text-text-main-light dark:text-text-main-dark">Unlock the power of your <span className="text-primary">data</span> today.</h2>
                            <p className="text-lg text-text-muted-light dark:text-text-muted-dark leading-relaxed mt-3">Join thousands of analysts and decision-makers who use DataWorld to visualize trends, forecast growth, and make data-driven decisions faster than ever.</p>
                            <div className="flex items-center gap-4 mt-8">
                                <div className="flex -space-x-3">
                                    <img alt="User avatar 1" className="w-10 h-10 rounded-full border-2 border-white dark:border-surface-dark" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmZ0WdNrLtCfQ9QGbMy2WcWsEDx2UIxbaTGSsjplv9R-9oEt_yNAMICEOOTGufBWPlb8wD8KzR2J4yhWy5-onQr5FFwdq1NKOKZ2JtvjLHrQPvTrjx7i34dLeXfmfKJLJa5w0EnvoFnyqtzHZiIW2s7chQ5QWRgptAxsytIUlZMYnPA9_WaNn1qeL5acBUnpBBwj7vaJqHjnqHDox93ZdePYutyTVJYwPvtCRj0eJqoO9J7nL_XC_N_DGU5L2ZuPRtBHCqKY58G9wk" />
                                    <img alt="User avatar 2" className="w-10 h-10 rounded-full border-2 border-white dark:border-surface-dark" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDieu5QGpy3ryOFADCFK2CvNqFtYm7WcbaEbjieHmCrAM68nvsb_NsHvZrZSD5_SL8qw58cjoiD_zndwOrDd6_Sjci-qn3P4k0CtaJ6VNQREv0Jiwi-Cb8uMp8Aptpk07l19A-dkIZuCtUfgmKCWKD4ry-6LzlDJTtGfbfxVXaXQGEzBDfw1qeeC9o1V_5gjrppeF0fuO2CbpM3Pk1f1L3E86_x9GvFksGSQExjWfDafoihMLtQKTqUvgy6Et8w4aBMnrHg9DPEixvW" />
                                    <img alt="User avatar 3" className="w-10 h-10 rounded-full border-2 border-white dark:border-surface-dark" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAZQMEPK0mCirwlt9nOc6T3khCMkIvJvDDW1h5_BYyrGL7X-LPdEUhDv1RQ0O-1YaUJT1UE4uv50uii8RkXBrsavkQ1f1pQhW7lINH7Jy7ihJXCmAUmey-gDmMblQcSfCu-J5zFwEY_xg-gVpiHrg6QYL3fzf5T1zYpGYZ2CnhElO_PAak7Y0PSsc3AiGLPOsengFfb_zluPAB6HLfLZ2Dfluu4EUkoN7VtsH4btmxu7CvWnslkPoRrAwtP6JsYeSU090O4uo9SYtCH" />
                                    <div className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-white dark:border-surface-dark bg-secondary text-white text-xs font-bold">+2k</div>
                                </div>
                                <div className="text-sm font-medium text-text-main-light dark:text-text-main-dark">
                                    ...
                                    <span className="text-text-muted-light dark:text-text-muted-dark">Trusted by industry leaders</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full max-w-md space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5 w-full">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-text-main-light dark:text-text-main-dark mb-1.5" htmlFor="name">Full Name</label>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-text-main-light dark:text-text-main-dark mb-1.5" htmlFor="email">Work Email</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-text-muted-light dark:text-text-muted-dark">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 col-span-1 md:col-span-2">
                                    <div>
                                        <label className="block text-sm font-medium text-text-main-light dark:text-text-main-dark mb-1.5" htmlFor="password">Password</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-text-muted-light dark:text-text-muted-dark">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-text-main-light dark:text-text-main-dark mb-1.5" htmlFor="confirm-password">Confirm</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-text-muted-light dark:text-text-muted-dark">
