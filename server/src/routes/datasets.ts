...
import { uploadDataset, getDatasets, getDatasetBlob, getDatasetById, getDatasetHistory } from '../controllers/datasetController';
...
router.get('/history', auth, getDatasetHistory);
